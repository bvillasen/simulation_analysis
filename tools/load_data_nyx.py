...
def load_snapshot_nyx( nSnap, inDir, hydro=True, particles=False, cic=False):
  data_dic = {'dm':{}, 'gas':{}}
  ...
  if hydro:
    data_gas = inFile['gas']
    data_dic['gas']['density'] = data_gas['density']
    data_dic['gas']['temperature'] = data_gas['temperature']
