...
for sim_id in range( n_sims ):
  ...
  scale_He_vals.append( scale_He )
  deltaZ_He_vals.append( deltaZ_He )
...
scale_He_vals  = np.array( list( set( scale_He_vals) ) )
deltaZ_He_vals = np.array( list( set( deltaZ_He_vals) ) )
scale_He_vals.sort()
deltaZ_He_vals.sort()


param_vals_x = scale_He_vals 
param_vals_y = deltaZ_He_vals
...
if extend: out_file_name += 'extended'
out_file_name += '.h5'
