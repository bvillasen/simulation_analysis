...
param_UVB_Rates[0]['values'] = [  0.36, 0.48, 0.60,  0.72  ]
...
param_UVB_Rates[2]['values'] = [ -0.10, 0.02, 0.14, 0.26   ]
...
if system == 'Shamrock':
  ...
  from parameters_UVB_rates_grid_small import param_UVB_Rates as param_UVB_Rates_grid_small
  ...
  if grid_name == 'grid_small': param_UVB_Rates = param_UVB_Rates_grid_small
