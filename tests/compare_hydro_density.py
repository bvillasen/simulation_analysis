...
# input_dir_gpu = data_dir + 'cosmo_sims/256_hydro_test/data_summit_gpu_part_grav/'
input_dir_gpu = data_dir + 'cosmo_sims/256_hydro_test/data_output_files/'
# input_dir_cpu = data_dir + 'sphere/data_summit_gpu_mpi/'
