...
data_name = 'cpu'
data_name = 'gpu_part'
data_name = 'gpu_part_grav'
data_name = 'gpu_mpi'
# input_dir_0 = data_dir + f'cosmo_sims/256_hydro_test/data_summit_{data_name}/'
input_dir_0 = data_dir + f'cosmo_sims/256_hydro_50Mpc/data_gpu_part_grav_caar/'
input_dir_1 = data_dir + f'cosmo_sims/256_hydro_50Mpc/data_gpu_part_grav_chem/'
